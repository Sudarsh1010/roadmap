		...
		<div className="mx-auto w-full max-w-6xl">
			...
			<main className="relative flex min-h-[60vh] w-full flex-col items-center justify-center gap-5 px-6 pt-[15vh] md:pt-36">
				...
				<h3 className="text-balance text-center text-muted-foreground max-sm:w-4/5 max-sm:text-sm">
					Discover a tailored roadmap to achieve your goals. Share
					your interests, and we'll create a customized learning plan
					just for you, using advanced AI technology from OpenAI and
					Google Gemini. Start your journey today and reach new
					heights with a plan designed uniquely for you.
				</h3>
				...
				<Popover>
					...
					<PopoverContent className="rounded-lg bg-yellow-300/30 px-3 py-2">
						<p className="text-center font-medium text-black text-xs">
							Note: We're still perfecting your personalized
							learning experience!
						</p>
					</PopoverContent>
				</Popover>
